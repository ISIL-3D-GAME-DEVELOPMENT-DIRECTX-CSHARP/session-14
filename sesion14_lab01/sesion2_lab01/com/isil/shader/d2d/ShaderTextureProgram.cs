...
namespace Sesion2_Lab01.com.isil.shader.d2d {
    public class ShaderTextureProgram {
        ...
        public ShaderTextureProgram(Device device) {
            mDevice = device;
        ...
        public void Load(string path) {
            ...
            inputElements[2] = new InputElement("TEXCOORD", 0, Format.R32G32_Float, 32, 0);
        ...
        public void Draw(Matrix transformation, NTexture2D texture) {
