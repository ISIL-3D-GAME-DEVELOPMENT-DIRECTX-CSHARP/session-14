...
namespace Sesion2_Lab01.com.isil.shader.d2d {
    public class ShaderBitmapFontTextureProgram {
        ...
        public ShaderBitmapFontTextureProgram(Device device) {
            mDevice = device;
            ...
            // blend state
            NBlend alphaBlend = NBlend.AlphaBlend();
            mBlendState = new BlendState(mDevice, alphaBlend.BlendStateDescription);
        }
        ...
        public void Load(string path) {
            ...
            inputElements[1] = new InputElement("TEXCOORD", 0, Format.R32G32_Float, 12, 0);
            ...
            mMiscInputBufferDescription.SizeInBytes = Utilities.SizeOf<ShaderBitmapFontInputParameters>();
        ...
        public void Update(float[] vertices, ushort[] indices) {
            ...
            mVertexBufferBinding.Stride = sizeof(float) * 5;
        ...
        public void Draw(Matrix transformation, NColor textColor, NTexture2D texture) {
            transformation = mWorld * transformation;
            transformation.Transpose();

            NColor newColor = NColor.ToNormalize(textColor);
            newColor.A = 1f;

            ShaderBitmapFontInputParameters inputParameters = ShaderBitmapFontInputParameters.EMPTY;
            inputParameters.textColor = newColor;
            inputParameters.transformation = transformation;

            // Set the Shader Constant Parameters
            SetConstantInputParameter<ShaderBitmapFontInputParameters>(mMiscInputBuffer,
