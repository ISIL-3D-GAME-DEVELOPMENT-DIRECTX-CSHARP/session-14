...
namespace Sesion2_Lab01.com.isil.content {
    public class NTexture2D {
        ...
        public void ChangeSamplerStateAddress(TextureAddressMode mode) {
            mSamplerStateDescription.AddressU = mode;
            mSamplerStateDescription.AddressV = mode;
            mSamplerStateDescription.AddressW = mode;
        }
